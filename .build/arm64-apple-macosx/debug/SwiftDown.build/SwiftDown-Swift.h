...
#ifndef SWIFTDOWN_SWIFT_H
#define SWIFTDOWN_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SwiftDown",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSData;
@class NSFileWrapper;
SWIFT_CLASS("_TtC9SwiftDown7Storage")
...
SWIFT_CLASS("_TtC9SwiftDown9SwiftDown")
@interface SwiftDown : NSView
